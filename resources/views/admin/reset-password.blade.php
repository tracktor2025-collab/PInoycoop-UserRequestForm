...
<div class="card login-card shadow">
    <div class="card-body p-4">
        ...
        <h1 class="h4 login-title">{{ $isCmsPortal ? 'Set Pinoycoop Password' : 'Set new password' }}</h1>
        <p class="text-muted login-subtitle">{{ $isCmsPortal ? 'Create a new password for your CMS admin account.' : 'Create a new password for your admin account.' }}</p>
