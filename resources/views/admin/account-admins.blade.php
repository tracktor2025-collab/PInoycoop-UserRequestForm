...
@section('content')
    ...
    <div class="mb-3">
        ...
        <p class="page-subtitle">Create admin users and keep existing admin records organized.</p>
    </div>
                ...
                @forelse($admins as $admin)
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif($admin->isCmsAdmin())
                                <span class="badge text-bg-info">CMS Admin</span>
                            @else
                ...
                <div class="row g-3 mt-1">
                    <div class="col-md-4">
                        ...
                        <select id="role" name="role" class="form-select @error('role') is-invalid @enderror" required>
                            ...
                            <option value="cms_admin" {{ old('role') === 'cms_admin' ? 'selected' : '' }}>CMS Admin</option>
