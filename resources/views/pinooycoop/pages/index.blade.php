  ...
  <div id="banner-carousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <div class="banner-slide" style="background-image: url('images/banner/banner-bg.jpg');">
      ...
      <div class="carousel-item">
        <div class="banner-slide" style="background-image: url('images/banner/slider-3.jpg');">
          <div class="overlay dark-overlay"></div>
          <div class="d-table">
            <div class="d-table-cell">
              <div class="container">
                <div class="row">
                  <div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
                    <div class="banner-content content-padding">
                      <h5 class="subtitle">Result-driven team</h5>
                      <h1 class="banner-title">Build your digital growth engine with confidence</h1>
                      <p>From strategy to execution, we help brands launch faster campaigns and improve online performance across channels.</p>
                      <a href="contact.html" class="btn btn-white btn-circled">lets start</a>
                    </div>
                  </div>
                </div>
      ...
      <div class="carousel-item">
        <div class="banner-slide" style="background-image: url('images/banner/bg-2.jpg');">
          <div class="overlay dark-overlay"></div>
          <div class="d-table">
            <div class="d-table-cell">
              <div class="container">
                <div class="row">
                  <div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
                    <div class="banner-content content-padding">
                      <h5 class="subtitle">Marketing experts</h5>
                      <h1 class="banner-title">Create campaigns that convert more customers</h1>
                      <p>We combine data, creative, and automation to move your leads through every stage of your sales funnel.</p>
                      <a href="contact.html" class="btn btn-white btn-circled">lets start</a>
                    </div>
                  </div>
                </div>
      ...
      <div class="carousel-item">
        <div class="banner-slide" style="background-image: url('images/banner/1.jpg');">
          <div class="overlay dark-overlay"></div>
          <div class="d-table">
            <div class="d-table-cell">
              <div class="container">
                <div class="row">
                  <div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
                    <div class="banner-content content-padding">
                      <h5 class="subtitle">Creative solutions</h5>
                      <h1 class="banner-title">Grow your brand with impactful digital storytelling</h1>
                      <p>Our team crafts memorable brand experiences that keep your audience engaged across web, social, and paid media.</p>
                      <a href="contact.html" class="btn btn-white btn-circled">lets start</a>
                    </div>
                  </div>
                </div>
      ...
      <div class="carousel-item">
        <div class="banner-slide" style="background-image: url('images/banner/why-choose.png');">
          <div class="overlay dark-overlay"></div>
          <div class="d-table">
            <div class="d-table-cell">
              <div class="container">
                <div class="row">
                  <div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
                    <div class="banner-content content-padding">
                      <h5 class="subtitle">Long-term partner</h5>
                      <h1 class="banner-title">Scale faster with a team that supports your goals</h1>
                      <p>We focus on measurable growth and clear reporting so you can make smarter decisions and expand sustainably.</p>
                      <a href="contact.html" class="btn btn-white btn-circled">lets start</a>
                    </div>
                  </div>
                </div>
